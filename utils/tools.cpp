...
//            	params.autostop = true;
            ...
            // [search-experiments hook] --spr-refine, --nni-refine, --spr-continuous,
            // --spr-perturb, --accept-dist, --perturb-slack: see
            // search_experiments/search_params.cpp
            if (parseSearchExperimentArg(argc, argv, cnt, params))
                continue;
...
//            << "  -pll                 Use phylogenetic likelihood library (PLL) (default: off)" << endl
    ...
    ;
    usageSearchExperiments(cout);   // [search-experiments hook]
    cout
...
//    store_candidate_trees = false;
    ...
    setSearchExperimentDefaults();   // [search-experiments hook] see search_experiments/search_params.cpp
#ifdef USING_PLL
    pll = true;
#else
    pll = false;
